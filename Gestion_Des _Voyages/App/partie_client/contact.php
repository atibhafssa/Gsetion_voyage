    ...
    if (preg_match($pcin, $cin)) {
        if(preg_match($telV, $telephone))
        {
            try {
              ...
              header("Location: reservation.php? cin=$cin & numovoyage=$numovoyage ");
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate pb-5 text-center">
            ...
            <form method="POST" class="bg-light p-5 contact-form" style="margin-top: -180px;">
              <div class="form-group">
                <input type="text"  placeholder="Your cin" name="cin" required >
              </div>
              ...
              <div class="form-group">
                <input type="text" required placeholder="your adresse" name="adresse">
              </div>
              <div class="form-group">
                <input type="text" required placeholder="your calle" name="tel">
              </div>
