...
<body data-spy="scroll" data-target="#myScrollspy" data-offset="20"  style="background-color:black;background-image:url('Capture3.PNG');" >
...
<ul>
  ...
  <li class="menu-css2"><a href="http://localhost/client/Dashio/Login_v4/index.php"> Déconnecté</a></li>
	...
	<a href="add.php"><span  id="span" >Ajouter Noveau Client</span> </a><br/><br/>
	<div class="divtab">
	<table   class="tab" border="1px" cellpadding="10px" cellspacing="0">
		<tr>
			<th>No_Client</th>
			<th>Nom</th>
			<th>Prénom</th>
 ...
 <?php	
            $ss = new Client_Service();
				  ...
				  echo "<td>";
		echo "<a href='Modifier Client.php ?cin=$cin'>Modifier</a>  |";   
	echo "<a href ='supprimer Client.php ?cin=$cin' onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a>";
