...
<ul>
  ...
  <li class="menu-css2"><a href="http://localhost/client/Dashio/Login_v4/index.php"> Déconnecté</a></li>
	...
	<h2>Gestion Des detais factures </h2>
	<a href="addInscreption.php"><span  id="span" >Ajouter Noveau Comande de client </span> </a><br/><br/>
	<div class="divtab">
	...
	<?php
				  ...
				  echo "<td>";
		echo "<a href='Modifier Reservation.php ? num=$num'  >Modifier </a>  |";   
	
	   echo "<a href ='Supprimer Reservation.php ?num=$num'onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a>|";

	echo "<a href ='Imprimer Reservation.php ? num=$num'> imprimer </a> ";
     echo "</td>";
